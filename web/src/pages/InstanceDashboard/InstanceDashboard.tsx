...
import { InstanceProvider, useInstanceContext } from "./context";
      ...
      <div class="flex">
        <div class="py-20">
          ...
          <ul class="menu bg-base-100 w-56">
            ...
            <li>
              <Link href={`/instances/${id}/overview`}>Overview</Link>
            </li>
            <li>
              <Link href={`/instances/${id}/stream`}>Stream</Link>
            </li>
            ...
            <li>
              <Link href={`/instances/${id}/ssh`}>Shell/SSH</Link>
            </li>
            ...
            <li>
              <Link href={`/instances/${id}/settings`}>Settings</Link>
            </li>
            <li>
              <Link href={`/instances/${id}/guidance-help`}>Guidance</Link>
            </li>
          </ul>
        </div>
