...
const TermsOfService: Component = () => {
  return (
    <DefaultLayout title="Terms of Service Agreement">
      ...
      <div class="m-10" id="document">
        <div class="p-20">
          <p class="alert alert-info">The English version of legal agreements and policies is considered as the only current and valid version of this document. Any translated version is provided for your convenience only, to facilitate reading and understanding of the English version. Any translated versions are not legally binding and cannot replace the English versions. In the event of disagreement or conflict, the English language legal agreements and policies shall prevail.</p>
        </div>

        <p class="text-neutral-300 pt-30 mb-10">Last Revised: 2023-08-23 15:09:51</p>
