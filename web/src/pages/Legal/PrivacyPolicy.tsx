...
const PrivacyPolicy: Component = () => {
  return (
    <LegalLayout title="Privacy Policy" revisionDateTime="3/05/2023">
      ...
      <h3>What information we collect, how we collect it, and why</h3>
      <p class="mb-4">
      ...
      <p class="mb-4">
        ...
        with which we have partnered to allow you to integrate their services into our own Services, and with trusted third party service providers
        as necessary for them to perform services on our behalf, such as:
      </p>
      ...
      <p class="mb-4">
        We want to serve you ads that are most relevant and useful to you, so we may use the personal information
        you provided us in Account Settings or those collected through cookie technologies to personalize ads and
        improve your overall experience with us on our site and other sites. We call this ad personalization
        (formerly, interest-based advertising) because the ads you see are based on previously collected or historical data
        to determine which ad will be most relevant to you, including data such as previous search queries, activity, visits to sites or apps,
        demographic information, or location. To illustrate ad personalization that is audience-based, let’s say you registered a domain with us and created a website using our website builder product.
        The next time you navigate to our advertising partner’s platform or website, they may recognize that you are a {company.DISPLAY_NAME} customer
        via a matched email and may use that data to help us display an ad about our latest promotion for website security.
        Alternatively, if you already purchased our website security product, then we may exclude you from future ad campaigns for
        this product because it wouldn’t be relevant to you. Other ad personalization could be activity-based.
        For example, using data about your page views on our site to determine whether an ad would be of interest to you.
        The information we share with our advertising channel partners to deliver you personalized ads is done securely and
        cannot be used by them for any other purpose. We do not sell your data to any third parties.
        In addition, the data we share is hashed and encrypted, which means that it does not directly identify you.
        We do not sell your data in any way to our partners or other third parties.
      </p>
      ...
      <h3 class="mb-4">How you can access, update or delete your data.</h3>
      ...
      <h3>The E.U-U.S and Swiss-U.S. Privacy Shield Frameworks.</h3>
      ...
      <h3>‘<em>Do Not Track</em>’ notifications.</h3>
