  ...
  return (
    <>
      ...
      <section class="p-10 bg-base-200">
        <div class="mb-10">
          <h2 class="text-4xl text-center font-bold mb-5">
      ...
      <section class="p-10 bg-base-200">
        <div class="mb-10">
          ...
          <p class="text-center">
            For businesses with on-premises requirements. Cutting-edge, high
      ...
      <section class="bg-base-200 flex flex-col-reverse md:flex-row md:py-10">
        <div class="flex flex-col justify-center flex-1 p-10">
          ...
          <p class="text-lg">
            Our team with more than twenty-five years of experience is building
            solutions that address real needs and challenges. Our products and
            services help small businesses run their complete IT infrastructure
            in the cloud or help extend the current IT infrastructure with new
            servers and virtual machines. Data center providers can use our
            products to improve issue resolution and technology support.
          </p>
        </div>
        ...
        <div class="flex-1">
          <img
            ...
            src="https://cdn.rentakloud.com/images/rak-rack.webp"
          />
        </div>
      </section>
      ...
      <section class="bg-base-200 flex flex-col-reverse md:flex-row-reverse md:py-10">
        <div class="flex flex-col justify-center flex-1 p-10">
          ...
          <p class="text-lg mb-4">
            Investing in cloud can go a long way. The global cloud computing
            market size was valued at over $500 billion in 2023. And it is
            expected to reach ~$2 trillion USD by 2030.
          </p>
          <p class="text-lg mb-4">
            Businesses are already looking for alternatives to big giants like
            AWS, Azure, GCP. Join our hands to build the cloud platform for
            future.
          </p>
          <div class="flex gap-4">
            <a
              target="_blank"
              href="https://cdn.rentakloud.com/rak-franchise-flyer.pdf"
              class="btn btn-primary"
            >
              Learn More
            </a>
      ...
      <section class="bg-base-200 flex flex-col md:flex-row py-10">
        <div class="flex-1">
          <img
            class="h-[500px] w-full object-contain"
            src="https://cdn.rentakloud.com/images/rak-server-inside.webp"
            loading="lazy"
          />
        </div>
        ...
        <div class="flex flex-col justify-center flex-1 p-10">
          ...
          <p class="text-lg mb-10">
            We are committed to providing additional features and functionality
            compared to our competitors. We like to stay at the forefront of
            technology and put a lot of emphasis on research and development of
            our products and servers to benefit our customers. Our experienced
            team is committed to our continuous improvement process to offer
            solutions to problems others don't provide.
          </p>
        </div>
      </section>
    </>
