...
export const VPS: Component<{ product: Product }> = (props) => {
  ...
  const subTitle = () => product().meta.headerSubtitle || product().shortDescription
  ...
  return <>
    ...
    <section class="text-center mt-20 container mx-auto">
      ...
      <h3 class="text-xl">Join the wave of developers building and scaling apps with simple cloud tools,
        top-tier reliability, and predictable pricing. Powerful and production-ready, our cloud platform has the
        solutions you need to succeed.</h3>
    </section>
    ...
    <section class="p-10">
      <h2 class="text-3xl text-center font-bold mb-5">Pricing That You'll Love</h2>
    ...
    <section class="container m-auto">
      <div class="p-20">
        ...
        <div class="text-center px-40 mb-10">
          <h2 class="text-4xl font-bold mb-4">Benefits to activate the builder in you</h2>
          <p class="">From simple tools and predictable pricing to support designed for
            growing businesses, RentAKloud's cloud is built to serve the unique needs of startups and SMBs.
          </p>
        </div>
        ...
        <div class="flex flex-wrap justify-center items-stretch gap-10">
          <Card
            ...
            class="w-1/3"
            img={{ uri: "//cdn.rentakloud.com/icons/Streamline-Ship.svg", alt: "ship icon" }}
          >
            <p class="">All of our products are built with simplicity at their core, so you can spend your time
              focusing on building apps, not infrastructure.
            </p>
          </Card>
          ...
          <Card
            ...
            class="w-1/3"
            img={{ uri: "//cdn.rentakloud.com/icons/Streamline-Lucky-cat-money.svg", alt: "treasure icon" }}
          >
            <p class="">Our fixed pricing and leading price-to-performance ratio contribute to an ROI
              of 187%. Now you never have to worry about insane cloud bills or any hidden costs.
            </p>
          </Card>
          ...
          <Card
            ...
            class="w-1/3"
            img={{ uri: "//cdn.rentakloud.com/icons/Streamline-Customer-service-woman.svg", alt: "support icon" }}
          >
            <p class="">Get free, personalized support or upgrade to paid plans to receive dedicated help and faster
              response times.
            </p>
          </Card>
          ...
          <Card
            ...
            class="w-1/3"
            img={{ uri: "//cdn.rentakloud.com/icons/Streamline-Programmer-male.svg", alt: "customer experience icon" }}
          >
            <p class="">Deliver superior customer experience with our globally distributed platform, minimal
              downtime, and intuitive products.
            </p>
          </Card>
        </div>
      </div>
