...
export const Congrats: Component = () => {
  ...
  const [counter, setCounter] = createSignal(7);
  ...
  return (
    <>
      <h1 class="text-4xl md:text-5xl text-center font-bold my-14">
        Congratulations!
      </h1>
      ...
      <p class="mb-6 max-w-xl">
        Your order has been placed successfully! You'll receive an email soon
        with the order details. We will also email you once your order has been
        shipped.
      </p>

      <p class="mb-6 max-w-xl">
        You'll be redirected to dashboard in{" "}
      ...
      <div class="flex gap-5 mt-10">
        ...
        <Link href="/dashboard/orders" class="btn btn-outline">
          Order History
        </Link>
      </div>
    </>
